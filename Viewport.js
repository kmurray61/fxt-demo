...
const Viewport = {
    ...
    createViewport : function () {
        try {
            ...
            Viewport.hasRendered();
        }
        catch ( e ) {
            console.log( "createViewport catch e = " + e );
        }
    },
    ...
    createViewportUI : function () {
        try {
            ...
            console.log( "createViewportUI catch e = " + e );
        }
    },
    ...
    createCarousel : function () {
        try {
            ...
            console.log( "createCarousel catch e = " + e );
        }
    },
    ...
    updateCell : function (cellNumb) {
        try {
            ...
            console.log( "updateCell catch e = " + e );
        }
    },
    ...
    updateCellCntIcons : function (name) {
        try {
            ...
            console.log( "updateCellCntIcons catch e = " + e );
        }
    },
    ...
    updateCellModal : function (name) {
        try {
            ...
            console.log( "updateCellModal catch e = " + e );
        }
    },
    ...
    updateCell2 : function (cellNumb) {
        try {
            ...
            console.log( "updateCell2 catch e = " + e );
        }
    },
    ...
    updateCell3 : function (cellNumb) {
        try {
            ...
            console.log( "updateCell3 catch e = " + e );
        }
    },
    hasRendered : function () {
        console.log( "Viewport hasRendered");
        return "Viewport Test Success";
    }
};
